...
| `/var/lib/ssh-guard/fail_attempts.log` | Rolling window of recent failed-login timestamps per IP |
...
- ❌ **SSH Login Failed** — host, user, source IP, location, and the current attempt count within the failure window
